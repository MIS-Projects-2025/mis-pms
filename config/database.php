    ...
    */
    ...
    'connections' => [
        ...
        'mis' => [
            'driver' => 'mysql',
            'url' => env('MISDB_URL'),
            'host' => env('MISDB_HOST', '127.0.0.1'),
            'port' => env('MISDB_PORT', '3306'),
            'database' => env('MISDB_DATABASE', 'laravel'),
            'username' => env('MISDB_USERNAME', 'root'),
            'password' => env('MISDB_PASSWORD', ''),
            'unix_socket' => env('MISDB_SOCKET', ''),
            'charset' => env('MISDB_CHARSET', 'utf8mb4'),
            'collation' => env('MISDB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
        ...
        'checklist' => [
            'driver' => 'mysql',
            'url' => env('CHDB_URL'),
            'host' => env('CHDB_HOST', '127.0.0.1'),
            'port' => env('CHDB_PORT', '3306'),
            'database' => env('CHDB_DATABASE', 'laravel'),
            'username' => env('CHDB_USERNAME', 'root'),
            'password' => env('CHDB_PASSWORD', ''),
            'unix_socket' => env('CHDB_SOCKET', ''),
            'charset' => env('CHDB_CHARSET', 'utf8mb4'),
            'collation' => env('CHDB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
