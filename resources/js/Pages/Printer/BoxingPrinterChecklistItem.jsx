...
export default function BoxingPrinterChecklistItem({ tableData, tableFilters, emp_data }) {
...
const submitAll = () => {
    ...
    router.post(route("boxing-printer-checklist-items.bulk-store"),
        { items: draftItems },
        {
            onSuccess: () => {
                setDraftItems([]);
  ...
  if (confirm("Are you sure you want to delete this machine?")) {
        ...
        <AuthenticatedLayout>
            ...
            <div className="flex items-center justify-between mb-4">
                <h1 className="text-2xl font-bold animate-bounce">
                    <i class="fa-solid fa-note-sticky"></i> Boxing Printer Checklist Items
                </h1>
    ...
    <div className="p-6">
        <h2 className="text-xl font-bold mb-4">
            ...
            New Boxing Printer Checklist Items
        </h2>
