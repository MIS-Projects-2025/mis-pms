...
class PrinterChecklistItemController extends Controller
{
    protected $datatable;
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Printer/PrinterChecklistItem', [
    ...
    {
        DB::connection('checklist')->table('printer_checklist_items')->where('id', $id)->delete();

        return redirect()->route('printer-checklist-items')->with('success', 'Checklist item removed successfully.');
    }
}
